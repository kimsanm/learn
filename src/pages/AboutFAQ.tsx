...
export default function AboutFAQ({ lang, theme }: AboutFAQProps) {
  ...
  const faqs = [
    ...
    },
    {
      ...
      a: lang === "en"
        ? "Yes! You can use promotional campaign codes (such as 'SABAI20' for 20% savings) to buy any creative courses listed inside Sabai Academy."
        : "បាទ/ចាស! លោកអ្នកអាចប្រើប្រាស់លេខកូដប្រូម៉ូសិន (ដូចជា 'SABAI20' បញ្ចុះតម្លៃ ២០%) សម្រាប់ទិញរាល់វគ្គសិក្សាទាំងអស់ដែលមាននៅក្នុងប្រព័ន្ធដោយគ្មានកំណត់។"
    }
  ];
      ...
      <section className="relative overflow-hidden rounded-3xl p-8 sm:p-12 text-center bg-radial from-slate-900 to-indigo-950 text-white border border-slate-800">
        ...
        <div className="max-w-2xl mx-auto space-y-4">
          ...
          <p className="text-sm sm:text-base text-slate-300 font-light leading-relaxed">
            {lang === "en"
              ? "At Sabai Academy, we believe digital literacy unlocks high-paying regional careers. We produce premium computer science instruction, complete lesson structures, and validation certificates carefully localized in Khmer."
              : "នៅសាបាយអាខាដឺមី យើងជឿជាក់ថាជំនាញបច្ចេកវិទ្យាល្អគឺជាសោរចាក់សោរអនាគត។ យើងផលិតវគ្គសិក្សាដែលមានគុណភាពខ្ពស់ ដំណោះស្រាយកូដជាក់ស្តែង និងវិញ្ញាបនបត្របញ្ជាក់ការសិក្សាបច្ចេកទេសផ្លូវការ។"}
          </p>
        </div>
      </section>
